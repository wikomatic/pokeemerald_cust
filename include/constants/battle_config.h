...
#define B_TERRAIN_TYPE_BOOST        GEN_3 // In Gen8+, speed is boosted by 30% instead of 50%.
...
#define B_RECOIL_IF_MISS_DMG        GEN_5 // In Gen5+, Jump Kick and Hi Jump Kick will always do half of the user's max HP when missing.
...
#define B_PAYBACK_SWITCH_BOOST      GEN_5 // In Gen5+, if the opponent switches out, Payback's damage will no longer be doubled.
...
// Ability settings
#define B_ABILITY_POP_UP            GEN_5 // In Gen5+, the Pokémon abilities are displayed in a pop-up, when they activate in battle.
...
#define B_MOODY_ACC_EVASION         GEN_3 // In Gen8+, Moody CANNOT raise Accuray and Evasion any more.
#define B_FLASH_FIRE_FROZEN         GEN_5 // In Gen5+, Flash Fire can trigger even when frozen, when it couldn't before.
